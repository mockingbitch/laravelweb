...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <script src="{{ url('public/backend') }}/js/validator.min.js"></script>

    <script>
        ClassicEditor.create(document.querySelector('#ckeditor2')).catch(error => {
            console.error(error)
        });
        CKEDITOR.replace(document.querySelector('#ckeditor2'));
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar"
                                            src="{{ url('public/backend') }}/images/3.png"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar"
                                            src="{{ url('public/backend') }}/images/1.png"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar"
                                            src="{{ url('public/backend') }}/images/2.png"></span>
                                    <span class="subject">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ URL::to('/list-category') }}">Danh sách sản phẩm</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ URL::to('/list-brand') }}">Danh sách thương hiệu</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ URL::to('/list-coupon') }}">Danh sách</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
        ...
        <section id="main-content">
            ...
            <div class="footer">
                <div class="wthree-copyright">
                    <p>© 2021 HoiQuan. All rights reserved | Design by <a href="http://facebook.com/jarvis.ejr">Phong
                            Tran</a></p>
                </div>
            </div>
            <!-- / footer -->
