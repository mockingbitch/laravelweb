    ...
    <div class="panel panel-default">
        ...
        <div class="table-responsive">
            <table class="table table-striped b-t b-light">
                ...
                if($value->br_status == 1) {
                    ?>
                                    <a href="{{ URL::to('/unactive-brand/' . $value->br_id) }}"><span
                    ...
                    ?>
                                    <a href="{{ URL::to('/active-brand/' . $value->br_id) }}"><span
                ...
                ?>
                            ...
                            <td>
                                <a href="{{URL::to('/edit-brand/'.$value->br_id)}}" class="active" ui-toggle-class="">
                                    <i class="fa fa-pencil-square-o text-success text-active" style="font-size:20px"></i></a>
                            </td>
                            <td>
                                <a onclick="return confirm('Are you fuckin sure about das?')" href="{{URL::to('/delete-brand/'.$value->br_id)}}" class="active" ui-toggle-class="">
        ...
        <footer class="panel-footer">
            <div class="row">
                ...
                <span>{{$listBrand->links('pagination::bootstrap-4') }}</span>
