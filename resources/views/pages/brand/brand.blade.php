                ...
                <div class="row animate-box col-md-9 col-padded-right">
                    <div class="col-md-12 col-md-offset-0 text-center fh5co-heading">
                        @foreach ($brand_name as $key => $value)
                            <h2><span>Brand: {{ $value->br_name }} </span></h2>
                        @endforeach
                    </div>
                    {{-- @foreach ($product_brid as $key => $value)
                        <div class="col-md-3">
                            <div class="fh5co-blog animate-box">
                                ...
                                <div class="blog-text">
                                    <h3><a href="{{ URL::to('/chi-tiet-san-pham/' . $value->pr_id) }}">{{ $value->pr_name }}</a>
                                    </h3>
                                    <h4>
                                        <a href="{{ URL::to('/chi-tiet-san-pham/' . $value->pr_id) }}">{{ number_format($value->pr_price) . ' VND' }}</a>
                                    </h4>
